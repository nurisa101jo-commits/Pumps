...
export type ExtractedCurve={kind:"head"|"efficiency"|"power"|"npsh";unit:ExtractedValue<string>;speedRpm:ExtractedValue<number>;frequencyHz:ExtractedValue<number>;points:ExtractedCurvePoint[];source?:SourceReference | undefined};
export type ExtractedMotor={code?:ExtractedValue<string>;powerKw:ExtractedValue<number>;voltageV?:ExtractedValue<number>;phase?:ExtractedValue<1|3>;frequencyHz?:ExtractedValue<50|60>;speedRpm?:ExtractedValue<number>;source?:SourceReference | undefined};
...
export type CatalogValidationIssue={field:string;severity:"error"|"warning";message:string;source?:SourceReference|undefined};
