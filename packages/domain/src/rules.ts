...
export type ConfigurationContext={configuration:PumpConfiguration;motor:Motor;flow:number;temperatureC?:number;fluidName?:string;application?:string;npshr?:number;optionIds?:Partial<Record<EngineeringOptionKind,string[]>>};
